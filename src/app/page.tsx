...
export const revalidate = 3600 // Cache page for 1 hour on CDN
...
export default async function Home() {
  ...
  const [
    ...
    fetchQuery(getNewManga({ limit: 5 })),
    fetchQuery(getTopMangaByTagId({ limit: 12, offset: 0 })),
    fetchQuery(getTopMangaByTagId({ limit: 12, offset: 0, publicationDemographic: 'shounen' })),
    fetchQuery(getTopMangaByTagId({ id: [ROMANCE], offset: 0, limit: 4 })),
    fetchQuery(getTopMangaByTagId({ id: [COMEDY], offset: 0, limit: 4 })),
    fetchQuery(getTopMangaByTagId({ id: [ACTION], offset: 0, limit: 4 }))
  ]).catch(err => {
    console.error('Failed to prefetch server side data', err)
      ...
      <div className='max-w-screen-2xl mx-auto px-4 md:px-12'>
        <Suspense fallback={<div className='h-[70vh] animate-pulse bg-white/5 rounded-[3rem] mt-24' />}>
          ...
          <section className='pt-8 md:pt-2'>
            <SlideMangaCardFullWidth id={''} initialData={newMangaData} />
          </section>
          ...
          <section className='mt-24'>
            ...
            <MangaTabs initialShounenData={shounenMangaData} />
          </section>
          ...
          <section className='mt-12'>
            ...
            <MangaByTagPage limitManga={12} pagination={false} initialData={recentlyUpdatedData} />
            <div className='mt-12 flex justify-center'>
              <Link
                href='/filter-search'
                className='px-12 py-4 glass-card rounded-2xl text-xs font-black uppercase tracking-[0.2em] text-white hover:bg-white/10 hover:border-primary/30 transition-all cursor-pointer active:scale-95'
              >
